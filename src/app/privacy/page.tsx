...
export default function PrivacyPage() {
    return (
        <div style={{
            backgroundColor: 'var(--color-bg)', /* Soft slate light gray */
            minHeight: '100vh',
            display: 'flex',
            ...
            <div style={{
                ...
                <article style={{ color: 'var(--color-text-secondary)', lineHeight: '1.7', fontSize: '1.0625rem' }}>
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>1. Introduction</h2>
                        <p>
                    ...
                    <section style={{
                        ...
                        border: '1px solid var(--color-primary-lightish)',
                        borderRadius: '1rem',
                        padding: '28px',
                        position: 'relative'
                    }}>
                        ...
                        <h3 style={{ fontSize: '1.125rem', fontWeight: '700', color: 'var(--color-primary)', marginBottom: '8px' }}>The Core Principle</h3>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>2. Information We Do NOT Collect</h2>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>3. Information We May Collect</h2>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>4. Cookies and Local Storage</h2>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>5. Third-Party Services</h2>
                        <p>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>6. Contact Us</h2>
                        <p>
