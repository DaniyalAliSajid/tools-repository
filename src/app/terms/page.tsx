    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <p style={{ fontSize: '0.875rem', color: 'var(--color-text-muted)', marginBottom: '40px', fontStyle: 'italic' }}>
                    Last Updated: March 8, 2028
                </p>

                <article style={{ color: 'var(--color-text-secondary)', lineHeight: '1.7', fontSize: '1.0625rem' }}>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>1. Use of Service</h2>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>2. Intellectual Property</h2>
                        <p>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>3. Privacy & Data Handling</h2>
                        <p>
                            Our priority is your privacy. Most of our tools process data locally in your browser. For more information on how we handle anonymous technical data and cookies, please review our <Link href="/privacy" style={{ color: 'var(--color-primary)', fontWeight: '600', textDecoration: 'none' }}>Privacy Policy</Link>.
                        </p>
                    </section>

                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>4. Third-Party Links & Advertisements</h2>
                        <p>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>5. Disclaimer of Warranties</h2>
                        <p>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>6. Limitation of Liability</h2>
                        <p>
                    ...
                    <section style={{ marginBottom: '40px' }}>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>7. Changes to Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 style={{ fontSize: '1.25rem', fontWeight: '700', color: 'var(--color-text)', marginBottom: '16px' }}>8. Contact Us</h2>
                        <p>
                            If you have any questions regarding these Terms, please contact us at{' '}
                            <Link href="mailto:support@toolrepository.com" style={{ color: 'var(--color-primary)', fontWeight: '600', textDecoration: 'none' }}>
